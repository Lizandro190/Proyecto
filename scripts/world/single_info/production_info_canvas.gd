...
@onready var label_comida : Label =  $PanelContainer/MarginContainer/HBoxContainer/ComidaBox/Comida
...
func _update_canvas() -> void:
	label_madera.text = str(SingleInfo.production_global.wood)
	label_piedra.text = str(SingleInfo.production_global.rock)
	label_comida.text = str(SingleInfo.production_global.food)
